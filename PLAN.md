...
- The empty workout list and compact editor were visually reviewed in Expo Go on an iPhone 16 Pro simulator. The review found and corrected a missing iOS content inset. The local database migration workflow issue is recorded as `I-013`, and the profile query warning found during runtime review is recorded as `I-014`.
